<?php
define('C_REST_CLIENT_ID','local.633824da808330.47872757');//Application ID
define('C_REST_CLIENT_SECRET','EBNUdHo5Us5MUL6c7qDcDcligeusrVcSmcomdieDmcu6V4Bbkt');//Application key
// or
