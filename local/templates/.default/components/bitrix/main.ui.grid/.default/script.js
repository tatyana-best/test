	...
	(function () {
	  ...
	  BX.Grid.Row.prototype = {
	    ...
	    getEditorContainer: function getEditorContainer(cell) {
	      console.log('Здесь выводится main-grid-editor-container ');
	      console.log('Файлы и папки/bitrix/components/bitrix/main.ui.grid/templates/.default/script.js');
	      console.log('Строка 4203');
