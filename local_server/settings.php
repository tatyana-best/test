<?php
define('C_REST_CLIENT_ID','local.6337ece4d68d97.10221489');//Application ID
define('C_REST_CLIENT_SECRET','0rB0MWF8qaQ0oP8f6s5QSsjDy7sGU6dLEeFmDQM8JPntYHBacq');//Application key
// or
